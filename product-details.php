					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									frw. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">frw.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button"style="background-color: #6f4d38;">Add to cart</button></a>
								<?php } else {?>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"style="background-color: #6f4d38;"><i class="fa fa-shopping-cart inner-right-vs"style="background-color: #6f4d38;"></i> ADD TO CART</a>
													<?php } else {?>
							<div class="action" style="color:red">Out of Stock</div>
					<?php } ?>
									</div>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					frw.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">frw.
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary"style="background-color: #6f4d38;">Add to cart</a>
