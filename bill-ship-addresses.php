...
<div class="form-group">
					    <label class="info-title" for="Billing Address"style="color: #85C285;"> Address<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State "style="color: #85C285;"> State  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City"style="color: #85C285;">City <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode"style="color: #85C285;">Pincode <span>*</span></label>
...
?>
					...
					<form class="register-form" role="form" method="post">
<div class="form-group">
					    <label class="info-title" for="Shipping Address"style="color: #85C285;">Address<span>*</span></label>
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Submit</button>
					</form>
					<?php } ?>
