...
<html lang="en">
	<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="assets/images/emmy1.png">
...
<!--<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/emmy1.png);">
				--><!-- /.container-fluid -->
			<!-- /.item -->
		<!--</div>--><!-- /.full-width-slider -->
	    
	    <!--<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/emmy2.png);">
			</div>--><!-- /.item -->
		<!--</div>--><!-- /.full-width-slider -->
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">1 Month Guarantee.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Deliver</h4>
						</div>
					</div>
					<h6 class="text">delivery over frw. 60000.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Discount</h4>
						</div>
					</div>
					<h6 class="text">buy more up to 20%</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">body care</a></li>
					<li><a href="#furniture" data-toggle="tab">hair care</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price" style="color:white;">
					frw.<?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount"style="color:red">frw.<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
									
			</div><!-- /.product-price -->
			
		</div><!-- /.product-info -->
		<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary" style="background-color: #6f4d38;">Buy Now</a></div>
				<?php } else {?>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Black hair</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Baby Grease</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Perfium</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($con,"select * from products where category=4 and subCategory=8");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
										...
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price" style="color:red">
													frw. <?php echo htmlentities($row['productPrice']);?>
												</span>
