				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs"style="background-color: #6f4d38;">Continue Shopping</a>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "frw"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "frw"." ".$row['shippingCharge']; ?>.00</span></td>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button"style="background-color: #6f4d38;">Update</button>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button"style="background-color: #6f4d38;">Update</button>
					<?php } ?>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"style="background-color: #6f4d38;">PROCCED TO CHEKOUT</button>
